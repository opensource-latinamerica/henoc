...
namespace HenocUniverse { class Object; } // added for flatland
typedef class HenocUniverse::Object* dGeomID; // added for flatland
typedef class HenocUniverse::Object dxGeom; // added for flatland
